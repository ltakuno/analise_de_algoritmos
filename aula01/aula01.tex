...
\itemtrig\ Depende:
 ...
 \vspace{-1cm} \hspace{1cm} \itemcirc\ quantidade de itens a serem ordenados
...
\begin{slide}
  ...
  Sim, tome $c = \frac{1}{4}$ e $n_0 = 12$
  
  \item[(b)] $n^2 - 2n = \Omega(n)$? 
  
  Sim , tome $c = 10$ e $n_0 = 18$
  \end{itemize}
  \end{slide}
...
\begin{slide}
  ...
  Sejam $f$, $g$ funções e $a, b \in R$
    ...
    \hspace{1cm} $f(n) = O(g(n)) \approx a\leq b $

    \vspace{-1cm} \hspace{1cm} $f(n) = \Omega(g(n)) \approx a \geq b$
    
    \vspace{-1cm} \hspace{1cm} $f(n) = \Theta(g(n)) \approx a = b$

    \vspace{-1cm} \hspace{1cm} $f(n) = o(g(n)) \approx a < b$

    \vspace{-1cm} \hspace{1cm} $f(n) = \omega(g(n)) \approx a > b$
\end{slide}
