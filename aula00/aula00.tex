...
\begin{slide}
  \stitle{Ementa}
	...
	\begin{enumerate}
	\item Prova de corretude
	
	\vspace{-0.5cm} \hspace{1cm} Corretude de algoritmos iterativos e recursivos
	\vspace{-1cm}\item Notação assintótica
	\end{enumerate}
...
\begin{slide}
  \stitle{Ementa}
	...
	\begin{enumerate}
	\vspace{-1cm}\item[3.] Divisão e conquista
	\vspace{-1cm}\item[4.] Métodos para resolver recorrência 
	
	 \vspace{-0.5cm} \hspace{1cm} Substituição, árvore de recursão e método mestre.
	\vspace{-1cm}\item[5.] Métodos de ordenação
	\end{enumerate}
...
\begin{slide}
  \stitle{Ementa}
	...
	\itemtrig\ Parte II: Projeto de algoritmos
	\begin{enumerate}
	\item Backtracking
	\vspace{-1cm} \item Métodos gulosos
	\vspace{-1cm} \item Programação dinâmica
	\vspace{-1cm} \item Algoritmos em grafos
	\end{enumerate}
...
\begin{tabular}{|c|c|c|} \hline
 ...
 Trab 1  & a definir & 2 semanas \\ \hline
 Prova 1 & 08/04/2021 & 2 semanas \\ \hline
 Trab 2  & a definir & 2 semanas \\ \hline
 Trab 3  & a definir  & 2 semanas \\ \hline
 Prova 2 & 03/06/2021 & 2 semanas \\ \hline
\end{tabular}
\end{center}
\end{slide}
